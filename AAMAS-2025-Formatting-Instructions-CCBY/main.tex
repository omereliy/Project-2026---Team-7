...
\begin{description}
    ...
    \item[H2 (Neural methods outperform traditional):] NeuMF with Focal Loss outperforms traditional collaborative filtering methods (KNN, SVD) on ranking metrics.
